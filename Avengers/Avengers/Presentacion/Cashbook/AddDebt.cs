    ...
    public partial class AddDebt : Form
    {
        ...
        private String errorDialog()
        {
            if (this.idioma == "ESPAÑOL")
            {
                ...
                if (string.IsNullOrEmpty(txtConcept.Text))
                {
        ...
        {
            return !String.IsNullOrEmpty(txtAmount.Text.Replace("'", "")) && !String.IsNullOrEmpty(txtConcept.Text.Replace("'", "")) && Utils.check.checkAmountPos(txtAmount.Text);
        }
        ...
        private String insertSql()
        {
            ...
            String sql = "insert into DEBTS values (null, '" + dateDebt.Value.ToString("dd/MM/yyyy") + "', " + this.u.getId() + ", '" + concept + "', " + amount + ", 0)";
            return sql;
        }
        
        private void intervaloFechas()
        {
            dateDebt.MinDate = DateTime.Today.AddDays(-12);
